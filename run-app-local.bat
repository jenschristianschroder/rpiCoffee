...
set APP_PORT=8080
set CLASSIFIER_ENDPOINT=http://127.0.0.1:%CLASSIFIER_PORT%
set LLM_ENDPOINT=http://127.0.0.1:%LLM_PORT%
set TTS_ENDPOINT=http://127.0.0.1:%TTS_PORT%
set REMOTE_SAVE_ENDPOINT=http://127.0.0.1:%REMOTE_SAVE_PORT%
